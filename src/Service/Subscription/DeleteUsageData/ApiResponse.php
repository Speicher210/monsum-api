...
class ApiResponse extends AbstractApiResponse
{
     ...
     * @var Request
     *
     * @JMS\Type("Speicher210\Monsum\Api\Service\Subscription\DeleteUsageData\Request")
     ...
     * @var array
     *
     * @JMS\Type("Speicher210\Monsum\Api\Service\Subscription\DeleteUsageData\Response")
