...
namespace Speicher210\Monsum\Api\Service\Customer\CreateSecureLink;
...
class ApiResponse extends AbstractApiResponse
{
     ...
     * @var Request
     *
     * @JMS\Type("Speicher210\Monsum\Api\Service\Customer\CreateSecureLink\Request")
     ...
     * @var Response
     *
     * @JMS\Type("Speicher210\Monsum\Api\Service\Customer\CreateSecureLink\Response")
