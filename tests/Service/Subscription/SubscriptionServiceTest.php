...
namespace Speicher210\Monsum\Test\Api\Service\Subscription;

use Speicher210\Monsum\Api\Model\Coupon;
use Speicher210\Monsum\Api\Model\Subscription;
use Speicher210\Monsum\Api\Service\Subscription\Cancel\ApiResponse as CancelApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Cancel\Response as CancelResponse;
use Speicher210\Monsum\Api\Service\Subscription\ChangeArticle\ApiResponse as ChangeArticleApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\ChangeArticle\RequestData as ChangeArticleRequestData;
use Speicher210\Monsum\Api\Service\Subscription\ChangeArticle\Response as ChangeArticleResponse;
use Speicher210\Monsum\Api\Service\Subscription\Create\ApiResponse as CreateApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Create\RequestData as CreateRequestData;
use Speicher210\Monsum\Api\Service\Subscription\Create\Response as CreateResponse;
use Speicher210\Monsum\Api\Service\Subscription\CreateSecureLink\ApiResponse as CreateSecureLinkApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\CreateSecureLink\Response as CreateSecureLinkResponse;
use Speicher210\Monsum\Api\Service\Subscription\DeleteUsageData\ApiResponse as DeleteUsageDataApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\DeleteUsageData\RequestData as DeleteUsageRequestData;
use Speicher210\Monsum\Api\Service\Subscription\DeleteUsageData\Response as DeleteUsageDataResponse;
use Speicher210\Monsum\Api\Service\Subscription\Get\ApiResponse as GetApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Get\RequestData as GetRequestData;
use Speicher210\Monsum\Api\Service\Subscription\Get\Response as GetResponse;
use Speicher210\Monsum\Api\Service\Subscription\GetUpcomingAmount\ApiResponse as GetUpcomingAmountApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\GetUpcomingAmount\RequestData as GetUpcomingAmountRequestData;
use Speicher210\Monsum\Api\Service\Subscription\GetUpcomingAmount\Response as GetUpcomingAmountResponse;
use Speicher210\Monsum\Api\Service\Subscription\GetUsageData\ApiResponse as GetUsageDataApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\GetUsageData\RequestData as GetUsageRequestData;
use Speicher210\Monsum\Api\Service\Subscription\GetUsageData\Response as GetUsageDataResponse;
use Speicher210\Monsum\Api\Service\Subscription\Postpone\ApiResponse as PostponeApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Postpone\Response as PostponeResponse;
use Speicher210\Monsum\Api\Service\Subscription\Reactivate\ApiResponse as ReactivateApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Reactivate\Response as ReactivateResponse;
use Speicher210\Monsum\Api\Service\Subscription\Renew\ApiResponse as RenewApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Renew\Response as RenewResponse;
use Speicher210\Monsum\Api\Service\Subscription\SetAddon\ApiResponse as SetAddonApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\SetAddon\RequestData as SetAddonRequestData;
use Speicher210\Monsum\Api\Service\Subscription\SetAddon\Response as SetAddonResponse;
use Speicher210\Monsum\Api\Service\Subscription\SetUsageData\ApiResponse as SetUsageDataApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\SetUsageData\RequestData as SetUsageRequestData;
use Speicher210\Monsum\Api\Service\Subscription\SetUsageData\Response as SetUsageDataResponse;
use Speicher210\Monsum\Api\Service\Subscription\SubscriptionService;
use Speicher210\Monsum\Api\Service\Subscription\Update\ApiResponse as UpdateApiResponse;
use Speicher210\Monsum\Api\Service\Subscription\Update\Response as UpdateResponse;
...
class SubscriptionServiceTest extends AbstractServiceTest
{
    ...
    public function testGetSubscriptionByIdReturnsOneSubscription()
    {
        ...
        static::assertEquals($expectedSubscription, $subscriptionService->getSubscriptionById(123));
    }
    ...
    public function testChangeSubscriptionArticleAction()
    {
        ...
        static::assertInstanceOf(ChangeArticleApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedChangeArticleResponse, $response);
    }
    ...
    public function testSetSubscriptionAddonAction()
    {
        ...
        static::assertInstanceOf(SetAddonApiResponse::class, $apiResponse);
    ...
    public function testSetSubscriptionUsageData()
    {
        ...
        static::assertInstanceOf(SetUsageDataApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedSetUsageDataResponse, $response);
    }
    ...
    public function testGetSubscriptionUsageData()
    {
        ...
        static::assertInstanceOf(GetUsageDataApiResponse::class, $apiResponse);
        /** @var GetUsageDataResponse $response */
        $response = $apiResponse->getResponse();

        $expectedGetUsageDataResponse = new GetUsageDataResponse();

        static::assertEquals($expectedGetUsageDataResponse, $response);
    }
    ...
    public function testDeleteSubscriptionUsageData()
    {
        ...
        static::assertInstanceOf(DeleteUsageDataApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedDeleteUsageDataResponse, $response);
    }
    ...
    public function testGetUpcomingAmount()
    {
        ...
        static::assertInstanceOf(GetUpcomingAmountApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedGetUpcomingAmountResponse, $response);
    }
    ...
    public function testPostponeSubscription()
    {
        ...
        static::assertInstanceOf(PostponeApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedPostponeResponse, $response);
    }
    ...
    public function testRenewSubscription()
    {
        ...
        static::assertInstanceOf(RenewApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedRenewResponse, $response);
    }
    ...
    public function testCancelSubscription()
    {
        ...
        static::assertInstanceOf(CancelApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedCancelResponse, $response);
    }
    ...
    public function testReactivateSubscription()
    {
        ...
        static::assertInstanceOf(ReactivateApiResponse::class, $apiResponse);
        ...
        static::assertEquals($expectedReactivateResponse, $response);
    }
